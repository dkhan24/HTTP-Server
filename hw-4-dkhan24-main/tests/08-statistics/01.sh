...
echo ""
curl -s http://127.0.0.1:$PORT/echo &> /dev/null #11
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #12
echo ""
curl -s http://127.0.0.1:$PORT/echo &> /dev/null #13
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #14
echo ""
curl -s http://127.0.0.1:$PORT/read &> /dev/null #15
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #16
echo ""
curl -s http://127.0.0.1:$PORT/echo &> /dev/null #17
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #18
echo ""
curl -s http://127.0.0.1:$PORT/tests/05-files/index.html &> /dev/null #19
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #20
echo ""
curl -s http://127.0.0.1:$PORT/Makefile &> /dev/null #21
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #22
echo ""
curl -s http://127.0.0.1:$PORT/runtests.sh &> /dev/null #23
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #24
echo ""
curl -s http://127.0.0.1:$PORT/tests/06-files/index.html &> /dev/null #25
echo ""
echo -n "$REQUEST" | nc 127.0.0.1 $PORT #26
echo ""
curl -s http://127.0.0.1:$PORT/tests/06-error/index.html &> /dev/null #27
